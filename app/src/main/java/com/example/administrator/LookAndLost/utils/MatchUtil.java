...
public class MatchUtil {
	...
	// 手机号码正则表达式
	private static String PHONEREG = "^(13\\d|178|147|15[0-35-9]|18[025-9])\\d{8}$";
	...
	//汉子正则
	private static String HAN_ZI="^[\u4E00-\u9FA5\uF900-\uFA2D]+$";
	...
	public static boolean isHanZi(String matchStr){
		return matchStr==null?false:matchStr.matches(HAN_ZI);
	}
